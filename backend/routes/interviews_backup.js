...
- For Developers: MUST include coding challenges with codeEditor object (enabled: true, language, starterCode, testCases), algorithm problems, system design basics
...
- For Developers: MUST include coding challenges with codeEditor, framework-specific coding, API integration, security coding practices, performance optimization
...
10. If you cannot generate exactly 5 questions for a round, use generic questions to reach the count of 5`;
    ...
    try {
      ...
      let jsonData = aiData;
      if (aiData.includes('```json')) {
        console.log('🔍 [INTERVIEW GENERATE] Detected markdown-wrapped JSON, extracting...');
        const jsonMatch = aiData.match(/```(?:json)?\s*(\{[\s\S]*?\})\s*```/);
        if (jsonMatch) {
          jsonData = jsonMatch[1];
          console.log('✅ [INTERVIEW GENERATE] Successfully extracted JSON from markdown');
        }
      }
      
      interviewData = JSON.parse(jsonData);
  ...
  const rounds = [
    {
      ...
      questions: isDataAnalyst ? [
      ...
      ] : isSales ? [
        {
          ...
          question: `Walk me through your sales process from lead generation to closing. What steps do you typically follow?`,
          expectedAnswer: "Look for understanding of sales methodology and systematic approach",
          timeLimit: 4,
          difficulty: "medium",
          followUpQuestions: ["How do you qualify leads?", "What's your average sales cycle length?"]
        },
        {
          id: "q1_2",
          type: "sales-tools",
          question: `What CRM systems and sales tools have you used? How do they help you manage your pipeline?`,
          expectedAnswer: "Assess technical proficiency with sales tools and pipeline management",
          timeLimit: 3,
          difficulty: "easy",
          followUpQuestions: ["How do you track your sales metrics?", "What reports do you generate?"]
        },
        {
          id: "q1_3",
          type: "sales-experience",
          question: `Tell me about your biggest sales achievement. What made it successful?`,
          expectedAnswer: "Look for sales performance, achievement metrics, and success factors",
          timeLimit: 4,
          difficulty: "medium",
          followUpQuestions: ["What was the deal size?", "How did you overcome challenges?"]
        },
        {
          id: "q1_4",
          type: "sales-approach",
          question: `How do you build rapport with new prospects? What's your approach to relationship building?`,
          expectedAnswer: "Assess relationship-building skills and customer-centric approach",
          timeLimit: 3,
          difficulty: "medium",
          followUpQuestions: ["How do you adapt to different personality types?", "What questions do you ask to understand needs?"]
        },
        {
          id: "q1_5",
          type: "sales-motivation",
          question: `What motivates you in sales? How do you stay motivated during difficult periods?`,
          expectedAnswer: "Look for intrinsic motivation, resilience, and sales mindset",
          timeLimit: 3,
          difficulty: "easy",
          followUpQuestions: ["How do you handle rejection?", "What drives your competitive spirit?"]
        }
      ] : [
        {
          id: "q1_1",
    ...
    },
    {
      ...
      questions: isDataAnalyst ? [
      ...
      ] : isSales ? [
        {
          id: "q2_1",
          type: "sales-roleplay",
          question: `Let's do a role-play! I'm a potential customer interested in our product. Start by introducing yourself and our product. I'll respond as a customer would, and we'll have a natural conversation.`,
          expectedAnswer: "AI will role-play as customer, provide real-time feedback, and guide sales techniques",
          timeLimit: 6,
          difficulty: "hard",
          followUpQuestions: [
        ...
        {
          id: "q2_4",
          type: "sales-scenarios",
          question: `How do you handle the objection 'Your price is too high'? Walk me through your approach step by step.`,
          expectedAnswer: "Assess value communication and price justification skills",
          timeLimit: 4,
          difficulty: "medium",
          followUpQuestions: ["What if they still say no?", "How do you create value perception?"]
        },
        {
          id: "q2_5",
          type: "sales-scenarios",
          question: `A prospect says 'We're not interested' after your initial pitch. How do you respond and potentially turn this around?`,
          expectedAnswer: "Evaluate persistence and qualification techniques",
          timeLimit: 4,
          difficulty: "medium",
          followUpQuestions: ["What questions would you ask?", "How do you handle rejection professionally?"]
        }
      ] : [
        {
          id: "q2_1",
    ...
    },
    {
      roundId: "round_3",
      roundNumber: 3,
      title: isSales ? "Sales Strategy & Market Analysis" : isDataAnalyst ? "Data Analysis & Insights" : isHiringManager ? "Talent Assessment & Decision Making" : "Problem-Solving & Critical Thinking",
      description: isSales ? "Test sales strategy development and market understanding" : isDataAnalyst ? "Test analytical thinking and data interpretation" : isHiringManager ? "Test talent evaluation and decision-making skills" : "Test analytical and problem-solving capabilities",
      duration: 20,
      questions: isSales ? [
        {
          id: "q3_1",
          type: "sales-strategy",
          question: `How would you approach selling to a new market segment that your company has never targeted before?`,
          expectedAnswer: "Assess market research skills, strategic thinking, and sales planning",
          timeLimit: 4,
          difficulty: "hard",
          followUpQuestions: ["How would you identify potential customers?", "What challenges do you anticipate?"]
        },
        {
          id: "q3_2",
          type: "market-analysis",
          question: `A competitor just launched a similar product at 30% lower price. How do you position your product and maintain your pricing?`,
          expectedAnswer: "Look for competitive analysis skills and value proposition development",
          timeLimit: 4,
          difficulty: "hard",
          followUpQuestions: ["How do you communicate value over price?", "What market research would you do?"]
        },
        {
          id: "q3_3",
          type: "sales-problem-solving",
          question: `Your biggest client is threatening to leave because of service issues. How do you retain them and prevent future problems?`,
          expectedAnswer: "Assess crisis management and relationship recovery skills",
          timeLimit: 4,
          difficulty: "hard",
          followUpQuestions: ["What's your immediate action plan?", "How do you prevent this from happening again?"]
        },
        {
          id: "q3_4",
          type: "sales-decision-making",
          question: `You have two potential deals: one large but low probability, one smaller but high probability. How do you allocate your time?`,
          expectedAnswer: "Look for prioritization skills and sales pipeline management",
          timeLimit: 3,
          difficulty: "medium",
          followUpQuestions: ["What factors influence your decision?", "How do you track progress on both?"]
        },
        {
          id: "q3_5",
          type: "sales-strategy",
          question: `How do you identify and approach decision-makers in large organizations?`,
          expectedAnswer: "Assess B2B sales skills and stakeholder mapping",
          timeLimit: 3,
          difficulty: "medium",
          followUpQuestions: ["What research do you do beforehand?", "How do you get past gatekeepers?"]
        }
      ] : [
        {
          id: "q3_1",
        ...
        },
        {
          ...
          question: `If you had to make a recommendation between two competing solutions, how would you evaluate and present your decision?`,
        ...
        },
        {
          id: "q3_3",
          type: "problem-solving",
          question: `How would you approach a critical issue that's affecting multiple stakeholders?`,
          expectedAnswer: "Assess crisis management and systematic problem-solving approach",
          timeLimit: 3,
          difficulty: "hard",
        ...
        },
        {
          id: "q3_5",
          type: "problem-solving",
          question: `How do you approach optimizing a process or workflow that's not performing well?`,
          expectedAnswer: "Assess systematic analysis and optimization methodology",
          timeLimit: 3,
          difficulty: "medium",
          followUpQuestions: ["What tools would you use?", "How do you measure improvement?"]
        }
      ],
      evaluationCriteria: isSales ? {
        strategy: "Sales strategy development and market understanding",
        analysis: "Market analysis and competitive positioning"
      } : {
    ...
    },
    {
      roundId: "round_4",
      roundNumber: 4,
      title: isSales ? "Advanced Sales Techniques & Negotiation" : isDataAnalyst ? "Data Visualization & Communication" : isHiringManager ? "Team Management & Development" : "Team Collaboration & Leadership",
      description: isSales ? "Test advanced sales skills and negotiation abilities" : isDataAnalyst ? "Test data presentation and stakeholder communication" : isHiringManager ? "Test team management and development skills" : "Evaluate teamwork and leadership potential",
      duration: 15,
      questions: isSales ? [
        {
          id: "q4_1",
          type: "negotiation",
          question: `A client wants a 40% discount on a large deal. How do you negotiate while maintaining profitability and relationship?`,
          expectedAnswer: "Assess negotiation skills and value-based selling",
          timeLimit: 4,
          difficulty: "hard",
          followUpQuestions: ["What alternatives could you offer?", "How do you create win-win solutions?"]
        },
        {
          id: "q4_2",
          type: "advanced-sales",
          question: `How do you handle complex B2B sales with multiple decision-makers and a long sales cycle?`,
          expectedAnswer: "Look for complex sales management and stakeholder navigation",
          timeLimit: 4,
          difficulty: "hard",
          followUpQuestions: ["How do you map the decision-making process?", "What's your follow-up strategy?"]
        },
        {
          id: "q4_3",
          type: "sales-communication",
          question: `How do you present complex technical products to non-technical buyers?`,
          expectedAnswer: "Assess communication skills and ability to simplify complex concepts",
          timeLimit: 3,
          difficulty: "medium",
          followUpQuestions: ["What analogies do you use?", "How do you ensure understanding?"]
        },
        {
          id: "q4_4",
          type: "sales-leadership",
          question: `How do you mentor and develop junior sales team members?`,
          expectedAnswer: "Look for leadership and coaching abilities in sales context",
          timeLimit: 3,
          difficulty: "medium",
          followUpQuestions: ["What's your coaching approach?", "How do you measure their progress?"]
        },
        {
          id: "q4_5",
          type: "sales-ethics",
          question: `How do you handle ethical dilemmas in sales, such as when a client asks for something that goes against company policy?`,
          expectedAnswer: "Assess ethical decision-making and integrity in sales",
          timeLimit: 3,
          difficulty: "medium",
          followUpQuestions: ["How do you maintain relationships?", "What's your escalation process?"]
        }
      ] : [
        {
          id: "q4_1",
        ...
        },
        {
          id: "q4_3",
          type: "teamwork",
          question: `How do you handle disagreements with team members about decisions?`,
      ...
      evaluationCriteria: isSales ? {
        negotiation: "Advanced negotiation and deal-closing skills",
        communication: "Ability to communicate complex concepts clearly"
      } : {
...
function ensureSixRounds(interviewData, jobDetails) {
  ...
  data.rounds = data.rounds.map((round, roundIndex) => {
    ...
    // If less than 5 questions, pad with role-appropriate questions
    while (questions.length < 5) {
      const questionIndex = questions.length + 1;
      
      // Determine role type for appropriate question generation
      const isSales = jobDetails.title.toLowerCase().includes('sales') || jobDetails.title.toLowerCase().includes('business development');
      const isDeveloper = jobDetails.title.toLowerCase().includes('developer') || jobDetails.title.toLowerCase().includes('engineer') || jobDetails.title.toLowerCase().includes('programmer');
      const isDataAnalyst = jobDetails.title.toLowerCase().includes('analyst') || jobDetails.title.toLowerCase().includes('data');
      const isHiringManager = jobDetails.title.toLowerCase().includes('manager') || jobDetails.title.toLowerCase().includes('hr') || jobDetails.title.toLowerCase().includes('recruiter');
      
      let question, type, expectedAnswer;
      
      if (isSales) {
        const salesQuestions = [
          { question: `How do you approach building relationships with new prospects in sales?`, type: 'sales-relationship', expectedAnswer: 'Relationship building approach' },
          { question: `What's your strategy for handling sales objections?`, type: 'sales-objection', expectedAnswer: 'Objection handling strategy' },
          { question: `How do you qualify leads and determine their potential?`, type: 'sales-qualification', expectedAnswer: 'Lead qualification process' },
          { question: `Describe your approach to closing deals.`, type: 'sales-closing', expectedAnswer: 'Closing techniques and approach' },
          { question: `How do you maintain long-term customer relationships?`, type: 'sales-retention', expectedAnswer: 'Customer retention strategy' }
        ];
        const salesQ = salesQuestions[questionIndex - 1] || salesQuestions[0];
        question = salesQ.question;
        type = salesQ.type;
        expectedAnswer = salesQ.expectedAnswer;
      } else if (isDeveloper) {
        // For developers, use generic questions that will be replaced by AI
        const devQuestions = [
          { question: `AI will generate appropriate coding questions for ${jobDetails.title}`, type: 'ai-generated', expectedAnswer: 'AI-generated assessment' },
          { question: `AI will generate system design questions for ${jobDetails.title}`, type: 'ai-generated', expectedAnswer: 'AI-generated assessment' },
          { question: `AI will generate technical problem-solving questions for ${jobDetails.title}`, type: 'ai-generated', expectedAnswer: 'AI-generated assessment' },
          { question: `AI will generate debugging and optimization questions for ${jobDetails.title}`, type: 'ai-generated', expectedAnswer: 'AI-generated assessment' },
          { question: `AI will generate architecture and best practices questions for ${jobDetails.title}`, type: 'ai-generated', expectedAnswer: 'AI-generated assessment' }
        ];
        const devQ = devQuestions[questionIndex - 1] || devQuestions[0];
        question = devQ.question;
        type = devQ.type;
        expectedAnswer = devQ.expectedAnswer;
      } else if (isDataAnalyst) {
        const dataQuestions = [
          { question: `How do you approach data cleaning and validation?`, type: 'data-analysis', expectedAnswer: 'Data cleaning methodology' },
          { question: `What's your experience with data visualization tools?`, type: 'data-analysis', expectedAnswer: 'Data visualization skills' },
          { question: `How do you ensure data accuracy in your analysis?`, type: 'data-analysis', expectedAnswer: 'Data accuracy practices' },
          { question: `Describe your approach to statistical analysis.`, type: 'data-analysis', expectedAnswer: 'Statistical analysis approach' },
          { question: `How do you communicate insights from data to stakeholders?`, type: 'data-analysis', expectedAnswer: 'Data communication skills' }
        ];
        const dataQ = dataQuestions[questionIndex - 1] || dataQuestions[0];
        question = dataQ.question;
        type = dataQ.type;
        expectedAnswer = dataQ.expectedAnswer;
      } else if (isHiringManager) {
        const hrQuestions = [
          { question: `How do you evaluate candidates during interviews?`, type: 'hr-evaluation', expectedAnswer: 'Candidate evaluation process' },
          { question: `What's your approach to building diverse teams?`, type: 'hr-diversity', expectedAnswer: 'Diversity and inclusion strategy' },
          { question: `How do you handle difficult conversations with employees?`, type: 'hr-communication', expectedAnswer: 'Employee communication skills' },
          { question: `Describe your experience with performance management.`, type: 'hr-performance', expectedAnswer: 'Performance management approach' },
          { question: `How do you develop and retain top talent?`, type: 'hr-development', expectedAnswer: 'Talent development strategy' }
        ];
        const hrQ = hrQuestions[questionIndex - 1] || hrQuestions[0];
        question = hrQ.question;
        type = hrQ.type;
        expectedAnswer = hrQ.expectedAnswer;
      } else {
        // Generic fallback
  ...
  while (data.rounds.length < 6) {
    ...
    // Determine role type for appropriate fallback questions
    const isSales = jobDetails.title.toLowerCase().includes('sales') || jobDetails.title.toLowerCase().includes('business development');
    const isDeveloper = jobDetails.title.toLowerCase().includes('developer') || jobDetails.title.toLowerCase().includes('engineer') || jobDetails.title.toLowerCase().includes('programmer');
    const isDataAnalyst = jobDetails.title.toLowerCase().includes('analyst') || jobDetails.title.toLowerCase().includes('data');
    const isHiringManager = jobDetails.title.toLowerCase().includes('manager') || jobDetails.title.toLowerCase().includes('hr') || jobDetails.title.toLowerCase().includes('recruiter');

    // Create role-appropriate fallback questions
    let fallbackQuestions;
    if (isSales) {
      fallbackQuestions = [
        { id: `q${idx}_1`, type: 'sales-fundamentals', question: `What are the key sales skills required for ${jobDetails.title}?`, expectedAnswer: 'Sales fundamentals and techniques', timeLimit: 3, difficulty: 'easy', followUpQuestions: [] },
        { id: `q${idx}_2`, type: 'sales-experience', question: `Describe your experience in sales and what you've learned.`, expectedAnswer: 'Sales experience and learning', timeLimit: 3, difficulty: 'medium', followUpQuestions: [] },
        { id: `q${idx}_3`, type: 'sales-approach', question: `How do you approach building relationships with customers?`, expectedAnswer: 'Relationship building approach', timeLimit: 3, difficulty: 'medium', followUpQuestions: [] },
        { id: `q${idx}_4`, type: 'sales-achievement', question: `Tell me about a successful sales achievement you're proud of.`, expectedAnswer: 'Sales achievement and impact', timeLimit: 3, difficulty: 'medium', followUpQuestions: [] },
        { id: `q${idx}_5`, type: 'sales-motivation', question: `What motivates you in sales and how do you stay driven?`, expectedAnswer: 'Sales motivation and drive', timeLimit: 3, difficulty: 'easy', followUpQuestions: [] }
      ];
    } else if (isDeveloper) {
      // For developers, let AI generate questions instead of using hardcoded ones
      fallbackQuestions = [
        { id: `q${idx}_1`, type: 'ai-generated', question: `AI will generate coding and technical questions for ${jobDetails.title}`, expectedAnswer: 'AI-generated assessment', timeLimit: 3, difficulty: 'medium', followUpQuestions: [] },
        { id: `q${idx}_2`, type: 'ai-generated', question: `AI will generate system design questions for ${jobDetails.title}`, expectedAnswer: 'AI-generated assessment', timeLimit: 3, difficulty: 'medium', followUpQuestions: [] },
        { id: `q${idx}_3`, type: 'ai-generated', question: `AI will generate problem-solving questions for ${jobDetails.title}`, expectedAnswer: 'AI-generated assessment', timeLimit: 3, difficulty: 'medium', followUpQuestions: [] },
        { id: `q${idx}_4`, type: 'ai-generated', question: `AI will generate technical experience questions for ${jobDetails.title}`, expectedAnswer: 'AI-generated assessment', timeLimit: 3, difficulty: 'medium', followUpQuestions: [] },
        { id: `q${idx}_5`, type: 'ai-generated', question: `AI will generate coding challenge questions for ${jobDetails.title}`, expectedAnswer: 'AI-generated assessment', timeLimit: 3, difficulty: 'medium', followUpQuestions: [] }
      ];
    } else if (isDataAnalyst) {
      fallbackQuestions = [
        { id: `q${idx}_1`, type: 'data-concepts', question: `What are key data analysis concepts for ${jobDetails.title}?`, expectedAnswer: 'Data analysis fundamentals', timeLimit: 3, difficulty: 'easy', followUpQuestions: [] },
        { id: `q${idx}_2`, type: 'data-experience', question: `Describe your experience with data analysis tools and techniques.`, expectedAnswer: 'Data analysis experience', timeLimit: 3, difficulty: 'medium', followUpQuestions: [] },
        { id: `q${idx}_3`, type: 'data-problem-solving', question: `How do you approach data quality and analysis challenges?`, expectedAnswer: 'Data problem-solving approach', timeLimit: 3, difficulty: 'medium', followUpQuestions: [] },
        { id: `q${idx}_4`, type: 'data-project', question: `Tell me about a data analysis project you've worked on.`, expectedAnswer: 'Data project experience', timeLimit: 3, difficulty: 'medium', followUpQuestions: [] },
        { id: `q${idx}_5`, type: 'data-tools', question: `What data analysis tools and software do you use regularly?`, expectedAnswer: 'Data tool proficiency', timeLimit: 3, difficulty: 'easy', followUpQuestions: [] }
      ];
    } else if (isHiringManager) {
      fallbackQuestions = [
        { id: `q${idx}_1`, type: 'hr-concepts', question: `What are key concepts in talent acquisition and management?`, expectedAnswer: 'HR and talent management fundamentals', timeLimit: 3, difficulty: 'easy', followUpQuestions: [] },
        { id: `q${idx}_2`, type: 'hr-experience', question: `Describe your experience in hiring and team management.`, expectedAnswer: 'HR and management experience', timeLimit: 3, difficulty: 'medium', followUpQuestions: [] },
        { id: `q${idx}_3`, type: 'hr-problem-solving', question: `How do you approach difficult hiring decisions and team challenges?`, expectedAnswer: 'HR problem-solving approach', timeLimit: 3, difficulty: 'medium', followUpQuestions: [] },
        { id: `q${idx}_4`, type: 'hr-project', question: `Tell me about a successful hiring or team development project.`, expectedAnswer: 'HR project experience', timeLimit: 3, difficulty: 'medium', followUpQuestions: [] },
        { id: `q${idx}_5`, type: 'hr-tools', question: `What HR tools and systems do you use regularly?`, expectedAnswer: 'HR tool proficiency', timeLimit: 3, difficulty: 'easy', followUpQuestions: [] }
      ];
    } else {
      ...
      fallbackQuestions = [
        ...
        { id: `q${idx}_2`, type: 'experience', question: `Describe your experience with ${jobDetails.title} responsibilities.`, expectedAnswer: 'Role experience', timeLimit: 3, difficulty: 'medium', followUpQuestions: [] },
        { id: `q${idx}_3`, type: 'problem-solving', question: `How do you approach challenges in this role?`, expectedAnswer: 'Problem-solving approach', timeLimit: 3, difficulty: 'medium', followUpQuestions: [] },
        { id: `q${idx}_4`, type: 'project', question: `Tell me about a relevant project you've worked on.`, expectedAnswer: 'Project experience', timeLimit: 3, difficulty: 'medium', followUpQuestions: [] },
        { id: `q${idx}_5`, type: 'skills', question: `What skills and tools do you use regularly in this role?`, expectedAnswer: 'Skill proficiency', timeLimit: 3, difficulty: 'easy', followUpQuestions: [] }
      ];
    }
