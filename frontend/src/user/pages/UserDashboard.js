  ...
  const renderOverview = () => (
    <div className="space-y-6">
      ...
      <motion.div
        ...
        className={`p-8 rounded-2xl ${isDarkMode ? 'bg-gradient-to-r from-blue-900/50 to-purple-900/50' : 'bg-gradient-to-r from-blue-50 to-purple-50'} border ${isDarkMode ? 'border-blue-800' : 'border-blue-200'}`}
      >
        <div className="flex items-center space-x-4">
          <div className={`p-4 rounded-full ${isDarkMode ? 'bg-blue-800/50' : 'bg-blue-100'}`}>
      ...
      <motion.div
        ...
        className={`rounded-xl ${isDarkMode ? 'bg-gray-800' : 'bg-white'} shadow-lg border ${isDarkMode ? 'border-gray-700' : 'border-gray-200'}`}
      >
          ...
          {progress?.interviewProgress?.length === 0 ? (
            ...
            <div className="space-y-4">
              {progress?.interviewProgress?.slice(0, 3).map((interview, index) => (
                <div key={interview.interviewId} className="flex items-center space-x-4 p-4 rounded-lg hover:bg-gray-50 dark:hover:bg-gray-700 transition-colors">
        ...
        <div className="grid gap-6">
          {progress?.interviewProgress?.map((interview, index) => (
            <motion.div
              ...
              className={`p-6 rounded-xl ${isDarkMode ? 'bg-gray-800' : 'bg-white'} shadow-lg border ${isDarkMode ? 'border-gray-700' : 'border-gray-200'} hover:shadow-xl transition-shadow`}
            >
