        ...
        <div className="grid grid-cols-1 lg:grid-cols-5 gap-8">
          ...
          <div className="lg:col-span-2">
            <div className="flex items-center space-x-2 mb-6">
              ...
              <span className="text-xl font-bold">AI Hiring</span>
            </div>
            <p className="text-gray-300 mb-6 max-w-md">
              Revolutionizing recruitment with AI-powered interviews, automated screening, 
              and data-driven hiring decisions. Find the perfect candidates faster than ever.
            </p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
          <div className="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
            <div className="text-gray-400 text-sm">
              © {currentYear} AI Hiring. All rights reserved.
            </div>
